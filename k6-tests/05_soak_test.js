...
export default function () {
  ...
  group("Soak — Home", () => {
    visitPage(`${BASE_URL}${ENDPOINTS.home.path}`,    "soak_home",     errorRate, responseTime, 3000);
    sleep(1);
    visitPage(`${BASE_URL}${ENDPOINTS.health.path}`,  "soak_health",   errorRate, responseTime, 3000);
    sleep(1);
    visitPage(`${BASE_URL}${ENDPOINTS.modulos.path}`, "soak_modulos",  errorRate, responseTime, 3000);
    sleep(1);
    visitPage(`${BASE_URL}${ENDPOINTS.sitios.path}`,  "soak_sitios",   errorRate, responseTime, 3000);
    sleep(1);
    visitPage(`${BASE_URL}${ENDPOINTS.plantillas.path}`, "soak_plantillas", errorRate, responseTime, 3000);
  });
  sleep(3);
}

...
export default function () {
  group("Stress — Home", () => {
    visitPage(`${BASE_URL}${ENDPOINTS.home.path}`,    "stress_home",     errorRate, pageLoad, 5000);
    sleep(0.3);
    visitPage(`${BASE_URL}${ENDPOINTS.health.path}`,  "stress_health",   errorRate, pageLoad, 5000);
    sleep(0.3);
    visitPage(`${BASE_URL}${ENDPOINTS.modulos.path}`, "stress_modulos",  errorRate, pageLoad, 5000);
    sleep(0.3);
    visitPage(`${BASE_URL}${ENDPOINTS.sitios.path}`,  "stress_sitios",   errorRate, pageLoad, 5000);
    sleep(0.3);
    visitPage(`${BASE_URL}${ENDPOINTS.plantillas.path}`, "stress_plantillas", errorRate, pageLoad, 5000);
  });
  sleep(0.2);
}
